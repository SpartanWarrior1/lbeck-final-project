...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://lbecktester.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        }
    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit} className="blog-manager-wrapper">
                <div className="two-columns">
                    ...
                    onChange={this.handleChange}
                    name="blog_status"
                    defaultValue={this.state.blog_status}
                    >
                        <option value="" disabled hidden>Blog Status</option>
